package com.dean.articlecomment.ui.xrecycleview;
...
public class XRecyclerView extends RecyclerView {
    ...
    private SwipeRefreshLayout mRefreshHeader;
    ...
    public void setRefreshing(boolean refreshing) {
        if (mRefreshHeader == null || !pullRefreshEnabled) {
            return;
        }
        if (refreshing) {
            mRefreshHeader.setRefreshing(false);
    ...
    public void setRefreshHeader(SwipeRefreshLayout refreshHeader) {
        if (mRefreshHeader == null) {
            this.mRefreshHeader = refreshHeader;
            mRefreshHeader.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                @Override
